...
{
    [CustomEditor(typeof(RoboNetworkManagerEditor), true)]
    [CanEditMultipleObjects]
    public class RoboNetworkManagerEditor : Editor
    {
        ...
        protected RoboNetworkManager m_NetworkManager;
        ...
        protected void Init()
        {
            ...
            m_Initialized = true;
            m_NetworkManager = target as RoboNetworkManager;
        ...
        public override void OnInspectorGUI()
        {
            ...
            ShowDerivedProperties(typeof(RoboNetworkManagerEditor), null);
        }
